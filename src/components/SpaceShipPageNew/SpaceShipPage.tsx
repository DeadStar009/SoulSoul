        ...
        <div className={`${s.leftWrap}`}>
          ...
          /> */}
            ...
            <div className={s.content}>
              <p className={s.desc}>
              <strong>DigiSoul</strong> is a cutting-edge platform that transforms financial behavior into credibility through <strong>Soulbound Tokens (SBTs)</strong>. Users securely share their financial data to receive an SBT that attests to their credibility, unlocking exclusive incentives from companies. Our <strong>affordable yearly subscription</strong> ensures accessibility, while businesses benefit from <strong>cost-efficient, data-driven marketing</strong> by paying per query to access credibility insights. This eliminates the inefficiencies of mass advertising, allowing companies to directly engage with their ideal audience. Additionally, <strong>20% of all company revenue</strong> is allocated to user rewards, fostering a sustainable and mutually beneficial ecosystem. DigiSoul is redefining how financial credibility drives real-world value.
